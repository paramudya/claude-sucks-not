...
```Your message will exceed the maximum image count for this chat. Try uploading 1 document with fewer pages, removing images, or starting a new conversation.```
